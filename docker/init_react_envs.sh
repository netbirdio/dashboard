...
WIRETRUSTEE_MGMT_GRPC_API_ENDPOINT=${WIRETRUSTEE_MGMT_GRPC_API_ENDPOINT}

# replace ENVs in the config
ENV_STR="\$\$AUTH0_DOMAIN \$\$AUTH0_CLIENT_ID \$\$AUTH0_AUDIENCE \$\$WIRETRUSTEE_MGMT_API_ENDPOINT \$\$WIRETRUSTEE_MGMT_GRPC_API_ENDPOINT"
