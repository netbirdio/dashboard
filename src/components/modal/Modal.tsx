    ...
    <ModalPortal>
      <ModalOverlay>
        <DialogPrimitive.Content
          ref={ref}
          className={cn(
            "mx-auto relative top-0 z-[52] grid w-full focus:outline-0 border border-nb-gray-600 dark:border-nb-gray-900 bg-white py-6 dark:shadow-lg shadow-sm duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1  data-[state=open]:slide-in-from-left-1 sm:rounded-lg md:w-full dark:bg-nb-gray",
            className,
            maxWidthClass,
          )}
      ...
      <ModalPortal>
        ...
        >
          <DialogPrimitive.Content
            ref={ref}
            className={cn(
              "ml-auto mt-auto relative bottom-0 z-[52] grid w-full border border-nb-gray-600 dark:border-nb-gray-900 bg-white py-6 dark:shadow-lg shadow-sm duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0  data-[state=closed]:slide-out-to-left-1  data-[state=open]:slide-in-from-left-1 md:w-full dark:bg-nb-gray",
