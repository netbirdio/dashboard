...
export const buttonVariants = cva(
  ...
  ],
  {
    variants: {
      variant: {
        default: [
          "bg-white hover:text-black focus:ring-neutral-200/50  hover:bg-neutral-100 border-nb-gray-700 text-neutral-900",
        ...
        dotted: [
          "bg-white hover:text-black focus:ring-neutral-200/50 hover:bg-neutral-100 border-nb-gray-700 text-neutral-900 border-dashed",
          "dark:ring-offset-neutral-950/50 dark:focus:ring-neutral-500/20  ",
        ...
        white: [
          "focus:ring-white/50 bg-white text-neutral-800 border-white outline-none hover:bg-neutral-200 disabled:dark:bg-nb-gray-920 disabled:dark:text-nb-gray-300",
