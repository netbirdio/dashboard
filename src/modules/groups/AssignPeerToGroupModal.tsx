              ...
              <div className={"flex items-center gap-2 mb-1 text-nb-gray-100"}>
                ...
                <div className={"flex gap-2 items-center"}>
                  ...
                  {groupName !== "All" && (
                    <button
                      className={
                        "flex items-center gap-2 dark:text-neutral-300 text-neutral-500 hover:text-nb-gray-100 transition-all hover:bg-nb-gray-800/60 py-2 px-3 rounded-md cursor-pointer"
                      }
