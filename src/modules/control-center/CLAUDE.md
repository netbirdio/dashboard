...
│   ├── useDraftPeerUpgrade.ts        → usePlaceholderUpgrade (swap placeholder→real peer in place, rewire edges, re-record policies; user-device selects keep their dropdown) + useDraftPeerUpgrade (watches peers, matches installHostname)
