export default {
  ...
  table: {
    ...
    selectRow: "Select row",
    filter: "Filter",
    filterCount: "{count} filter(s)",
    searchFilters: "Search filters...",
    noMatchingFilters: "There are no filters matching your search.",
  },
  dateRange: {
  ...
  groups: {
    ...
    searchByNameOrEmail: "Search for users by name or email...",
    noUsersToSelect:
      "There are no users to select. Invite some users for this tenant before unlinking.",
    noUsersMatchingSearch: "There are no users matching your search.",
  ...
  reverseProxy: {
    ...
    user: "User",
    method: "Method",
    locationIpPlaceholder: "e.g. 10.0.0.5 or Berlin",
    searchProxyEvents: "Search by IP, host, path, user...",
    noProxyEventsTitle: "No Proxy Events Yet",
    noProxyEventsDescription:
      "No proxy traffic yet. Events appear here once your reverse proxy services start serving requests.",
    region: "Region",
    regionCopied: "Region has been copied to your clipboard",
    ipAddressCopied: "IP address has been copied to your clipboard",
    servicesDescription:
