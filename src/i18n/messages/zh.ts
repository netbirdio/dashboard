export default {
  ...
  table: {
    ...
    noMatchingFilters: "没有与搜索匹配的筛选条件。",
  },
  dateRange: {
  ...
  groups: {
    ...
    searchUser: "搜索用户...",
    selectUser: "选择用户...",
    searchByNameOrEmail: "按姓名或邮箱搜索用户...",
    noUsersToSelect: "没有可选择的用户。请先邀请该租户的用户，再执行解除关联。",
    noUsersMatchingSearch: "没有与搜索匹配的用户。",
    searchResource: "搜索资源...",
    used: "已使用",
    unused: "未使用",
    usage: "使用情况",
  ...
  reverseProxy: {
    ...
    user: "用户",
    method: "方法",
    locationIpPlaceholder: "例如 10.0.0.5 或北京",
    searchProxyEvents: "按 IP、主机、路径或用户搜索...",
    noProxyEventsTitle: "暂无代理事件",
    noProxyEventsDescription:
      "暂无代理流量。当反向代理服务开始处理请求后，事件会显示在这里。",
    region: "地区",
    regionCopied: "地区已复制到剪贴板",
    ipAddressCopied: "IP 地址已复制到剪贴板",
