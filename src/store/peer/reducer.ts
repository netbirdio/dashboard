...
const peer = createReducer<Peer | null, ActionTypes>(
  initialState.peer as Peer
...
const deletedPeer = createReducer<DeleteResponse<string | null>, ActionTypes>(
  initialState.deletedPeer
)
...
const updateGroupsVisible = createReducer<boolean, ActionTypes>(
  initialState.setUpdateGroupsVisible
).handleAction(
  actions.setUpdateGroupsVisible,
...
const updatedPeer = createReducer<CreateResponse<Peer | null>, ActionTypes>(
  initialState.updatedPeer
)
