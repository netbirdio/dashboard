...
export const AccessControls = () => {
    ...
    const sortTable = (e) => {
        let ruleCopy = [...rules];
        if (e === "0") {
            ruleCopy.sort((a, b) => (a.email > b.email ? 1 : -1));
        } else if (e === "1") {
            ruleCopy.sort((a, b) => (a.email > b.email ? -1 : 1));
        } else if (e === "2") {
                                                                                                ...
                                                                                                {cell.column.id === "Flow" &&
                                                                                                    (cell.value === 0 ? (
                                                                                                        <span
                                                                                                            ...
                                                                                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
                                                                                                              <path strokeLinecap="round" strokeLinejoin="round" d="M7 16l-4-4m0 0l4-4m-4 4h18 M17 8l4 4m0 0l-4 4m4-4H3"/>
                                                                                                            </svg>
                                                                                                        </span>
                                                                                                    ) : (
                                                                                                        <span
