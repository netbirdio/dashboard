...
export const Routes = () => {
  ...
  const itemsMenuAction = [
    {
      key: "view",
      label: (
        <Button type="text" block onClick={() => onClickViewRoute()}>
          View
        </Button>
      ),
    },
    {
      key: "delete",
      label: (
        <Button type="text" block onClick={() => showConfirmDelete()}>
          Delete
        </Button>
      ),
    },
  ...
  const renderPopoverGroups = (
    ...
    let btn = (
      <Button type="link" onClick={() => setRouteAndView(userToAction)}>
      ...
      >
        <Column
          ...
          render={(text, record) => {
            return (
              <span
                onClick={() => setRouteAndView(record as RouteDataTable)}
              ...
              <Card bodyStyle={{ padding: 0 }}>
                ...
                >
                  <Column
                    ...
                    align="center"
                    sorter={(a, b) =>
                      (a as any).network_id.localeCompare((b as any).network_id)
                    }
                    render={(text, record) => {
                      const desc = (
                    ...
                    render={(count, record: RouteDataTable) => {
                      ...
                      return (
                        <div>
                          ...
                          <Button
                            type="link"
                            onClick={() => setRouteAndView(record)}
                          >
                            Configure
                          </Button>
                        </div>
